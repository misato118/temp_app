...
export type GetEmployeeIdQuery = { __typename?: 'Query', employeeId: { __typename?: 'Employee', id: number, firstName: string, lastName: string, birthDate: Date, email: string, imageURL?: string | null, company: { __typename?: 'Company', id: number, name: string } } };
